			...
			<main className={styles.homemain}>
				<div className={styles.hometrip}>
					<div className={styles.hometriptext}>
						...
						<div className={styles.hometrippic} key={homeTrips[0].id}>
							<Link href={`/trips/${homeTrips[0].id}`}>
								<a>
									<Image
										src={homeTrips[0].imgUrl}
										alt={homeTrips[0].name}
										layout="responsive"
										width={302}
										height={450}
									/>
									<h3>{homeTrips[0].name}</h3>
								</a>
							</Link>
						</div>
				</div>
